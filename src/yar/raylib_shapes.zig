// Raylib Shapes Module (rshapes)
// 2D shape drawing, splines, and collision detection functions
...
//----------------------------------------------------------------------------------
// Shape Drawing and Collision Functions (extern functions)
//----------------------------------------------------------------------------------
...
pub extern fn CheckCollisionPointPoly(point: Vector2, points: [*]const Vector2, pointCount: c_int) bool;
