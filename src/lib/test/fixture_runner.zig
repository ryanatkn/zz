...
// TODO: Temporarily disabled due to ZON parser segfault in complex test environment
// The ZON parser works fine in isolation but causes segfaults when used with
// multiple allocators in test fixture loading. Need deeper investigation.
// See TODO_DOC.md item #22 for details.
//
